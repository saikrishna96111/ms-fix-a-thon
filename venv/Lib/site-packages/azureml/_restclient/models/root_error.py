...
class RootError(Model):
    ...
    def __init__(self, code=None, severity=None, message=None, message_format=None, message_parameters=None, reference_code=None, details_uri=None, target=None, details=None, inner_error=None):
