...
from azureml._common._core_user_error.user_error import AuthorizationStorageAccount, BadDataUpload
...
def upload_blob_from_stream(stream, url, content_type=None, session=None, timeout=None, backoff=None, retries=None):
    ...
    if(blob_properties.content_length != file_size):
        raise AzureMLException._with_error(
            AzureMLError.create(
                BadDataUpload, content_length=blob_properties.content_length,
                file_size=file_size
            )
        )
